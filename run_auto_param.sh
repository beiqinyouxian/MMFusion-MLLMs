...
SCENE="NIGHT" # DAY 或者 NIGHT 或者 ALL
...
python Auto_modal_param.py --threshold $THRESHOLD --dataset $DATASET --objects $SPLITBY --scene $SCENE --eval_type $EVAL_TYPE --attention_type $ATTENTION_TYPE --model_path $MODEL_PATH --data_root $DATA_ROOT 2>&1 
